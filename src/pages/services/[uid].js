...
const ServicesSingle = ({ page, marquee }) => {
  ...
  return (
    <>
      ...
      />
      <main>
        <Hero headline={data?.hero_title} image={data?.hero_image} />
        <Intro
        ...
        />
        <MarqueeBlock marqueeID={page?.id} content={marqueeData} />
      </main>
      <Modal>
...
export async function getStaticProps({ params, preview, previewData }) {
  ...
  const page = (await client.getByUID("services_single", params.uid)) || {};
