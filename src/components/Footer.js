...
const Facebook = () => (
  <svg width="48" height="48" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M26.348 17.767h2.532V14h-2.995c-3.612.154-4.353 2.192-4.415 4.323v1.883H19v3.674h2.47v9.88h3.705v-9.88h3.057l.586-3.674h-3.643v-1.142a1.224 1.224 0 011.173-1.297z" fill="#282829" />
  </svg>
);
        ...
        <ContentContainer as={Grid}>
          <StyledAddress>
            ...
            <UnstyledList>
              ...
              {emailAddress ?
                <li>
                  <span>
                    Email: <InlineLink href={`mailto:${emailAddress}`}>{emailAddress}</InlineLink>
                  </span>
                </li>
                :
                null
          ...
          <Form>
            ...
            <FieldWrap>
              ...
              />
              <Submit type="submit" bgcolor="brand-white">Submit</Submit>
            </FieldWrap>
          </Form>
